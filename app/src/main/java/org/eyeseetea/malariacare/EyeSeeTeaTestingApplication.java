 ...
 */
public class EyeSeeTeaTestingApplication extends Application {
    ...
    private static EyeSeeTeaTestingApplication mInstance;
    ...
    public void onCreate() {
        ...
        FlowConfig flowConfig = new FlowConfig
                .Builder(this)
                .addDatabaseHolder(EyeSeeTeaInMemoryGeneratedDatabaseHolder.class)
                .build();
    ...
    public static EyeSeeTeaTestingApplication getInstance() {
        return mInstance;
    }
    ...
    public void setIsAppWentToBg(boolean isAppWentToBg) {
        EyeSeeTeaTestingApplication.isAppWentToBg = isAppWentToBg;
    }
    ...
    public void setIsWindowFocused(boolean isWindowFocused) {
        EyeSeeTeaTestingApplication.isWindowFocused = isWindowFocused;
    }
    ...
    public void setIsBackPressed(boolean isBackPressed) {
        EyeSeeTeaTestingApplication.isBackPressed = isBackPressed;
    }
}
