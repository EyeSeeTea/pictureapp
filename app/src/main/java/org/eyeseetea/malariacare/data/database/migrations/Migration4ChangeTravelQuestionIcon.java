...
public class Migration4ChangeTravelQuestionIcon extends BaseMigration {
    private static String TAG = ".Migration2";

    private static Migration4ChangeTravelQuestionIcon instance;
    private boolean postMigrationRequired;

    public Migration4ChangeTravelQuestionIcon() {
        instance = this;
