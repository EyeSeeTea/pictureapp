...
public class PullRequiredOnPreferenceChangeListener implements
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            PreferencesState.getInstance().saveStringPreference(preference.getKey(), newValue.toString());
    ...
    private boolean preferenceIsDhisUrl(Preference preference) {
        return preference.getKey() == preference.getContext().getResources().getString(R.string.dhis_url);
    }
