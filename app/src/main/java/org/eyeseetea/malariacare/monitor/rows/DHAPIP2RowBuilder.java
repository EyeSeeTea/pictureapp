 ...
 */
public class DHAPIP2RowBuilder extends CounterRowBuilder {

    public DHAPIP2RowBuilder(Context context){
        super(context, context.getString(R.string.monitor_row_title_dhapip2));
    }

    @Override
    protected boolean hasToIncrement(Survey survey) {
        return SurveyStats.isDHAPIP2(survey);
    }
}
