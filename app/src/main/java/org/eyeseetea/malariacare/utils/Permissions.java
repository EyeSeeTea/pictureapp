...
public class Permissions {
    ...
    public void init(){
        ...
        addPermission(new Permission(FINE_LOCATION_REQUEST_CODE, android.Manifest.permission.ACCESS_FINE_LOCATION));
        addPermission(new Permission(PHONE_STATE_REQUEST_CODE, android.Manifest.permission.READ_PHONE_STATE));
    }
