...
public class StockService extends IntentService {
    ...
    private void prepareStockData() {
        ...
        Date lastEvenSurveyDate = SurveyDB.getLastDateForSurveyType(Constants.SURVEY_RESET);
        ...
        List<SurveyDB> sentSurveysForStock = SurveyDB.findSurveysWithProgramAndGreaterDate(
                ProgramDB.findByUID(PreferencesState.getInstance().getContext().getString(
