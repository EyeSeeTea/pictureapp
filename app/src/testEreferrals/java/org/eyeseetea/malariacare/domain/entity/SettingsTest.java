...
public class SettingsTest {
    ...
    public void should_return_user_program() {
        ...
        Settings settings = new Settings(systemLanguage, currentLanguage, null, false, false, false,
                programUser, programPass, programUrl, null, null, null, null);
    ...
    public void should_return_webServiceUrl_if_provided() {
        ...
        Settings settings = new Settings(systemLanguage, currentLanguage, null, false, false, false,
                programUser, programPass, webServiceUrl, null, null, null, null);
    ...
    public void should_return_webUrl_if_provided() {
        ...
        Settings settings = new Settings(systemLanguage, currentLanguage, null, false, false, false,
                programUser, programPass, programUrl, webUrl, null, null, null);
    ...
    public void should_return_font_size() {
        ...
        Settings settings = new Settings(systemLanguage, currentLanguage, null, false, false, false,
                programUser, programPass, programUrl, null, fontSize, null, null);
    ...
    public void should_return_program_url() {
        ...
        Settings settings = new Settings(systemLanguage, currentLanguage, null, false, false, false,
                programUser, programPass, programUrl, null, null, programUrl, null);
    ...
    public void should_return_program_endpoint() {
        ...
        Settings settings = new Settings(systemLanguage, currentLanguage, null, false, false, false,
                programUser, programPass, programUrl, null, null, null, programEndpoint);
